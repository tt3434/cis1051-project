#reminderprogram broken verison
...
def specifictime(text,dict):
        ...
        if a == date_time:
            ...
            while f:
                ...
                if answer == 'yes':
                    ...
                    f=False
                    while c:
                        response=str(input("Would you like to delete your reminder?"))
                        if response == 'yes':
                            #dict.clear()
                            #print(dict)
                            #del dict[text]
    ...
    while loop2:
        ask = str(input("Would you like to set a new reminder?"))
        if ask == 'yes':
